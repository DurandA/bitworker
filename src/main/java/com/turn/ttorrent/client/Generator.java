...
public class Generator implements Runnable {
	...
	private Set<GenerationListener> listeners;
	private Thread thread;

	public Generator(SharedTorrent torrent) {
		this.torrent = torrent;

		this.listeners = new HashSet<GenerationListener>();
		this.thread = null;
	}
	 ...
	 */
	public void register(GenerationListener listener) {
